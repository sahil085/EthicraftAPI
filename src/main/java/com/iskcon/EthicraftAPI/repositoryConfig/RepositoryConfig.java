package com.iskcon.EthicraftAPI.repositoryConfig;
...
@EnableJpaRepositories("com.iskcon.EthicraftAPI.repository")
@ComponentScan(basePackages = { "com.iskcon.EthicraftAPI.repository"},
